...
class Battle {
	...
	sendGameState() {
		...
		for (let i = 0; i < enemyPokemonList.length; i++) {
			...
			x.push({species: enemyPokemonList[i].getSpecies().num, type: enemyPokemonList[i].getSpecies().types, stats: enemyPokemonList[i].getSpecies().baseStats , hp: enemyPokemonList[i].hp / enemyPokemonList[i].maxhp, isActive: enemyPokemonList[i].isActive(), move1: enemyPokemonList[i].moveTrack[0], move2: enemyPokemonList[i].moveTrack[1], move3: enemyPokemonList[i].moveTrack[2], move4: enemyPokemonList[i].moveTrack[3], statusEffect: status, boosts: enemyPokemonList[i].boosts, fainted: enemyPokemonList[i].fainted});
		}
		// @ts-ignore
