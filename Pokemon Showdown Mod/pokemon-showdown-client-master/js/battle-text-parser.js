...
return _line18+_template52.replace('[POKEMON]',this.pokemon(_pokemon23)).replace('[STAT]',this.stat(stat)).replace('[ITEM]',this.effect(kwArgs.from));
}
...
_template60=this.template('block',kwArgs.from);
