...
getBaseTemplate=function getBaseTemplate(){
...
sendGameState=function sendGameState(){
...
var PokemonList=this.myPokemon;
var enemyPokemonList=this.yourSide.pokemon;
...
var status=PokemonList[i].status;
...
x.push({species:Dex.getTemplate(PokemonList[i].species).num,type:Dex.getTemplate(PokemonList[i].species).types,stats:Dex.getTemplate(PokemonList[i].species).baseStats,move1:move1.id,move2:move2.id,move3:move3.id,move4:move4.id,move1Type:move1.type,move2Type:move2.type,move3Type:move3.type,move4Type:move4.type,move1power:move1.basePower,move2power:move2.basePower,move3power:move3.basePower,move4power:move4.basePower,hp:PokemonList[i].hp/PokemonList[i].maxhp,isActive:PokemonList[i].active,statusEffect:status,boosts:boosts,fainted:PokemonList[i].fainted});
}

for(var _i5=0;_i5<enemyPokemonList.length;_i5++){
var status=enemyPokemonList[_i5].status;
if(enemyPokemonList[_i5].status===null||enemyPokemonList[_i5].status===""||enemyPokemonList[_i5].status===undefined){
status="";
}
x.push({species:enemyPokemonList[_i5].getTemplate().num,type:enemyPokemonList[_i5].getTemplate().types,stats:enemyPokemonList[_i5].getTemplate().baseStats,hp:enemyPokemonList[_i5].hp/enemyPokemonList[_i5].maxhp,isActive:enemyPokemonList[_i5].isActive(),move1:enemyPokemonList[_i5].moveTrack[0],move2:enemyPokemonList[_i5].moveTrack[1],move3:enemyPokemonList[_i5].moveTrack[2],move4:enemyPokemonList[_i5].moveTrack[3],statusEffect:status,boosts:enemyPokemonList[_i5].boosts,fainted:enemyPokemonList[_i5].fainted});
}
...
hasPseudoWeather=function hasPseudoWeather(weather){for(var _i6=0,_this$pseudoWeather=
this.pseudoWeather;_i6<_this$pseudoWeather.length;_i6++){var _ref=_this$pseudoWeather[_i6];var pseudoWeatherName=_ref[0];
...
this.scene.reset();for(var _i7=0,_this$sides=

this.sides;_i7<_this$sides.length;_i7++){var _side=_this$sides[_i7];
...
updateToxicTurns=function updateToxicTurns(){for(var _i8=0,_this$sides2=
this.sides;_i8<_this$sides2.length;_i8++){var _side2=_this$sides2[_i8];for(var _i9=0,_side2$active=
_side2.active;_i9<_side2$active.length;_i9++){var poke=_side2$active[_i9];
if((poke==null?void 0:poke.status)==='tox')poke.statusData.toxicTurns++;
}
}
};_proto3.
...
updatePseudoWeatherLeft=function updatePseudoWeatherLeft(){for(var _i10=0,_this$pseudoWeather2=
this.pseudoWeather;_i10<_this$pseudoWeather2.length;_i10++){var pWeather=_this$pseudoWeather2[_i10];
if(pWeather[1])pWeather[1]--;
if(pWeather[2])pWeather[2]--;
}for(var _i11=0,_this$sides3=
this.sides;_i11<_this$sides3.length;_i11++){var _side3=_this$sides3[_i11];
...
var pp=1;
if(move.target==="all"){for(var _i12=0,_pokemon$side$foe$act=
pokemon.side.foe.active;_i12<_pokemon$side$foe$act.length;_i12++){var active=_pokemon$side$foe$act[_i12];
...
}else{for(var _i13=0,_kwArgs$spread$split=
kwArgs.spread.split(',');_i13<_kwArgs$spread$split.length;_i13++){var hitTarget=_kwArgs$spread$split[_i13];
...
switch(_effect.id){
case'lunardance':for(var _i14=0,_poke$moveTrack=
_poke.moveTrack;_i14<_poke$moveTrack.length;_i14++){var trackedMove=_poke$moveTrack[_i14];
trackedMove[1]=0;
}
...
var stats=args[3]?args[3].split(', '):['atk','def','spa','spd','spe','accuracy','evasion'];for(var _i15=0;_i15<
stats.length;_i15++){var _stat4=stats[_i15];
...
var _stats=args[3]?args[3].split(', '):['atk','def','spa','spd','spe','accuracy','evasion'];for(var _i16=0;_i16<
_stats.length;_i16++){var _stat7=_stats[_i16];
_poke8.boosts[_stat7]=frompoke.boosts[_stat7];
if(!_poke8.boosts[_stat7])delete _poke8.boosts[_stat7];
}
if(this.gen>=6){
var volatilesToCopy=['focusenergy','laserfocus'];for(var _i17=0;_i17<
volatilesToCopy.length;_i17++){var volatile=volatilesToCopy[_i17];
...
case'-clearallboost':{
var timeOffset=this.scene.timeOffset;for(var _i18=0,_this$sides4=
this.sides;_i18<_this$sides4.length;_i18++){var _side4=_this$sides4[_i18];for(var _i19=0,_side4$active=
_side4.active;_i19<_side4$active.length;_i19++){var active=_side4$active[_i19];
if(active){
active.boosts={};
...
case'-cureteam':{
var _poke22=this.getPokemon(args[1]);for(var _i20=0,_poke22$side$pokemon=
_poke22.side.pokemon;_i20<_poke22$side$pokemon.length;_i20++){var _target2=_poke22$side$pokemon[_i20];
_target2.status='';
...
_poke28.addVolatile('formechange',species);for(var _i21=0,_tpoke$moveTrack=
tpoke.moveTrack;_i21<_tpoke$moveTrack.length;_i21++){var _trackedMove=_tpoke$moveTrack[_i21];
...
_poke35.removeTurnstatus('protect');for(var _i22=0,_poke35$side$pokemon=
_poke35.side.pokemon;_i22<_poke35$side$pokemon.length;_i22++){var curTarget=_poke35$side$pokemon[_i22];
...
var foeActive=[];for(var _i23=0,_poke35$side$foe$acti=
_poke35.side.foe.active;_i23<_poke35$side$foe$acti.length;_i23++){var maybeTarget=_poke35$side$foe$acti[_i23];
...
switch(_effect21.id){
case'gravity':
if(!this.fastForward){for(var _i24=0,_this$sides5=
this.sides;_i24<_this$sides5.length;_i24++){var _side7=_this$sides5[_i24];for(var _i25=0,_side7$active=
_side7.active;_i25<_side7$active.length;_i25++){var _active=_side7$active[_i25];
...
if((active==null?void 0:active.searchid)===searchid&&!isSwitch){
active.slot=slot;
return active;
}
for(var i=0;i<this.p1.pokemon.length;i++){
var _pokemon3=this.p1.pokemon[i];
if(_pokemon3.fainted&&(isNew||isSwitch))continue;
if(isSwitch||isInactive){
if(this.p1.active.indexOf(_pokemon3)>=0)continue;
}
if(isSwitch&&_pokemon3===this.p1.lastPokemon&&!this.p1.active[slot])continue;
if(searchid&&_pokemon3.searchid===searchid||
!searchid&&_pokemon3.ident===pokemonid){
if(slot>=0)_pokemon3.slot=slot;
return _pokemon3;
}
if(!_pokemon3.searchid&&_pokemon3.checkDetails(details)){
_pokemon3=this.p1.newPokemon(this.parseDetails(name,pokemonid,details,{item:_pokemon3.item}),i);
if(slot>=0)_pokemon3.slot=slot;
return _pokemon3;
}
}
...
if((_active2==null?void 0:_active2.searchid)===searchid&&!isSwitch){
if(slot>=0)_active2.slot=slot;
return _active2;
}
for(var _i26=0;_i26<this.p2.pokemon.length;_i26++){
var _pokemon4=this.p2.pokemon[_i26];
if(_pokemon4.fainted&&(isNew||isSwitch))continue;
if(isSwitch||isInactive){
if(this.p2.active.indexOf(_pokemon4)>=0)continue;
}
if(isSwitch&&_pokemon4===this.p2.lastPokemon&&!this.p2.active[slot])continue;
if(searchid&&_pokemon4.searchid===searchid||
!searchid&&_pokemon4.ident===pokemonid){
if(slot>=0)_pokemon4.slot=slot;
return _pokemon4;
}
if(!_pokemon4.searchid&&_pokemon4.checkDetails(details)){
_pokemon4=this.p2.newPokemon(this.parseDetails(name,pokemonid,details,{item:_pokemon4.item}),_i26);
if(slot>=0)_pokemon4.slot=slot;
return _pokemon4;
}
}
...
case'poke':{
var _pokemon5=this.getPokemon('new: '+args[1],args[2]);
if(args[3]==='item'){
_pokemon5.item='(exists)';
}
break;
}
case'teampreview':{
